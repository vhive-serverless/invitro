...
if __name__ == '__main__': 
    output_path = '/users/gaow0007/loader-gpt/data/real-multi-func-gputraces/example'
    ...
    for func_idx, func_info in enumerate(func_invocations): 
        ref_df = pd.read_csv(f'{output_path}/reference_{func_idx}.csv')
        ...
        for i in range(360): 
            ...
            func_invocations[func_idx].append(num_jobs)
