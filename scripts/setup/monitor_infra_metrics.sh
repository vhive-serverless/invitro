...
server_exec 'tmux send -t prometheusd "kubectl port-forward -n monitoring service/loader-kube-prometheus-sta-prometheus 9090" ENTER'

#* Find all service monitors
server_exec "sudo kubectl -n monitoring patch prometheus loader-kube-prometheus-sta-prometheus --type json -p '[{"op": "replace", "path": "/spec/serviceMonitorSelector", "value": {}}, {"op": "replace", "path": "/spec/serviceMonitorNamspaceSelector", "value": {}}]'"
