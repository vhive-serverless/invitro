...

{
	...
	server_exec "cd loader; helm install -n monitoring --version 43.2.1 $release_label prometheus-community/kube-prometheus-stack -f config/prometh_stack_values.yaml"
