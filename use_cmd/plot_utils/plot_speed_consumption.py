...
inference_info = {
    'Llama-7B': [[1, 2, 4, 8], [0.933418560028076, 1.0656738758087158, 1.0699684143066406, 1.0785574913024902]], 
    'GPT2': [[1, 2, 4, 8], [0.102386665344238, 0.112379035949707, 0.113362004852295, 0.1223550483703613] ], 
}

prompt_info = {
    'Llama-7B': [[1, 2, 4, 8], [0.895644664764404, 1.23575210571289, 1.87380838394165, 2.118852615356445]], 
    'GPT2': [[1, 2, 4, 8], [0.306276512145996, 0.579740333557129, 0.80010643005371, 1.12291736602783]], 
}
...
for model in ['GPT2', 'Llama-7B']: 
    ...
    ax.set_ylabel('Execution Time [s]', fontsize=fontsize)
    ...
    # Show the plot
    plt.savefig(f'{root}/images/client_training/speed_{model}.jpg', bbox_inches='tight')
    print(f'{root}/images/client_training/speed_{model}.png')