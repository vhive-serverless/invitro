...
type SchedRequest struct {
	...
	AvailableGPU      int32  `protobuf:"varint,8,opt,name=availableGPU,proto3" json:"availableGPU,omitempty"`           // avaliable number of GPUs
}
...
func (x *SchedRequest) GetAvailableGPU() int32 {
	if x != nil {
...
var file_sched_proto_rawDesc = []byte{
	...
	0x47, 0x50, 0x55, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x61, 0x76, 0x61, 0x69, 0x6c,
