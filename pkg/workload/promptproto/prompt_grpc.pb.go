...
type ExecutorClient interface {
	...
	Execute(ctx context.Context, in *PromptRequest, opts ...grpc.CallOption) (*PromptReply, error)
}
...
func (c *executorClient) Execute(ctx context.Context, in *PromptRequest, opts ...grpc.CallOption) (*PromptReply, error) {
	out := new(PromptReply)
	err := c.cc.Invoke(ctx, "/prompt.Executor/Execute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExecutorServer interface {
	// Remote execution via RPC call.
	Execute(context.Context, *PromptRequest) (*PromptReply, error)
...
func (UnimplementedExecutorServer) Execute(context.Context, *PromptRequest) (*PromptReply, error) {
...
func _Executor_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/prompt.Executor/Execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServer).Execute(ctx, req.(*PromptRequest))
	}
