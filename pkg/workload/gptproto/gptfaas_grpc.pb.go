...
type ExecutorClient interface {
	...
	Execute(ctx context.Context, in *GPTFaasRequest, opts ...grpc.CallOption) (*GPTFaasReply, error)
}
...
func (c *executorClient) Execute(ctx context.Context, in *GPTFaasRequest, opts ...grpc.CallOption) (*GPTFaasReply, error) {
	out := new(GPTFaasReply)
	err := c.cc.Invoke(ctx, "/gptfaas.Executor/Execute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExecutorServer interface {
	// Remote execution via RPC call.
	Execute(context.Context, *GPTFaasRequest) (*GPTFaasReply, error)
...
func (UnimplementedExecutorServer) Execute(context.Context, *GPTFaasRequest) (*GPTFaasReply, error) {
...
func _Executor_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gptfaas.Executor/Execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServer).Execute(ctx, req.(*GPTFaasRequest))
	}
