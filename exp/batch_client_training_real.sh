...
for duration in 5 10 20 # 40 60 # 5 10 20 # 5 # 10 20 # 20 # 20 30 # 10 # 5 10 # 20 # 30 40 60 80 120 150 240 # 10 20 30 40 60 # 80 120 150 240
do
    for load in 0.3 0.5 0.7 #  0.7 # 0.5 # 0.3 0.5 0.7
    do 
        ...
        for method in elastic_flow infless # elastic_flow
        do 
