...
for duration in 60 # 10 20 40 60 # 80 120 150 240 
do
    ...
    go run cmd/loader.go --config cmd/config_client_batch_gpu.json  --overwrite_duration ${duration} # > log/batch_log_$duration.txt
    clean_env "$@"
